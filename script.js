...
const translations = {
  en: {
    ...
    approach: "Approach",
    contact: "Contact",
    heroTitle: "Straightforward software solutions for managing operations, teams, and resources — without the chaos.",
    ...
    erpDesc: "Tailored business management structures designed to map your actual workflows, organize company data, and keep different departments in sync.",
    toolsTitle: "Intuitive Internal Tools",
    toolsDesc: "Clean, easy-to-use control dashboards built specifically for your staff to manage daily checklists, client requests, and operations without clutter.",
    trackingTitle: "Inventory & Asset Tracking",
    trackingDesc: "Practical database solutions for accurate balance tracking, real-time item status updates, and transparent transaction logs.",
    backendTitle: "Secure Business Backends",
    backendDesc: "Stable, dependable system frameworks that securely handle data storage, processing rules, and user access permissions.",
    prodReadyLabel: "Software Ready-to-Deploy",
    prodMainTitle: "Our Management Modules",
    hrmTitle: "Human Resource Management",
    hrmDesc: "Handles team structures, personnel records, and employee status tracking. Helps companies organize internal development and simplify day-to-day HR processes.",
    wmsTitle: "Warehouse Management (WMS)",
    wmsDesc: "Optimizes product storage, inventory movement, and stock tracking. Automates core warehouse operations to cut down manual errors and lower costs.",
    pawnTitle: "Pawnshop Management",
    pawnDesc: "Keeps track of collateral assets, customer files, and financial agreements. Streamlines daily retail transactions and simplifies inventory logs.",
    gymTitle: "Gym & Complex Management",
    gymDesc: "Web-based software that simplifies membership management, access control, subscription handling, and financial oversight.",
    ...
    p1Desc: "We don't build confusing, overdesigned systems. Our software focuses on intuitive layouts, readable fonts, and distinct functional views so your team can work instantly without endless training.",
    p2Heading: "No Feature Bloat",
    p2Desc: "We stick to what is useful. By intentionally omitting unnecessary administrative buttons and hidden menus, we build lightweight tools that solve problems directly and maintain speed.",
    p3Heading: "Clean, Maintainable Code",
    p3Desc: "We use predictable, modular, and type-safe code bases. This makes updates, software expansions, and cross-branch rollouts uncomplicated as your business footprint grows.",
    ctaTitle: "Let's organize your operational tools.",
    ctaDesc: "Contact our development team directly to discuss your system needs, project timelines, or platform integration details.",
  ...
  az: {
    ...
    approach: "Yanaşma",
    contact: "Əlaqə",
    heroTitle: "Əməliyyatların, komandaların və resursların xaos olmadan idarə edilməsi üçün sadə proqram təminatı həlləri.",
    ...
    erpDesc: "Real iş axınlarınızı əks etdirmək, şirkət məlumatlarını təşkil etmək və fərqli şöbələrin sinxron işləməsini təmin etmək üçün hazırlanmış xüsusi biznes idarəetmə sistemləri.",
    toolsTitle: "İntuitiv Daxili Alətlər",
    toolsDesc: "Heyətinizin gündəlik yoxlama siyahılarını, müştəri sorğularını və əməliyyatları qarışıqlıq olmadan idarə etməsi üçün xüsusi olaraq hazırlanmış təmiz, istifadəsi asan idarəetmə panelləri.",
    trackingTitle: "Anbar və Aktivlərin İzlənməsi",
    trackingDesc: "Dəqiq qalıq izlənməsi, real vaxt rejimində məhsul statusunun yenilənməsi və şəffaf əməliyyat jurnalları üçün praktiki verilənlər bazası həlləri.",
    backendTitle: "Təhlükəsiz Biznes Backend Altyapıları",
    backendDesc: "Məlumatların saxlanılmasını, emal qaydalarını və istifadəçi giriş icazələrini təhlükəsiz şəkildə idarə edən sabit, etibarlı sistem çərçivələri.",
    ...
    hrmDesc: "Komanda strukturlarını, personal qeydlərini və işçilərin statusunun izlənməsini idarə edir. Şirkətlərə daxili inkişafı təşkil etməyə və gündəlik HR proseslərini sadələşdirməyə kömək edir.",
    wmsTitle: "Anbar İdarəetmə Sistemi (WMS)",
    wmsDesc: "Məhsulların saxlanmasını, inventar hərəkətini və ehtiyatların izlənməsini optimallaşdırır. Mexanik səhvləri azaltmaq və xərcləri aşağı salmaq üçün əsas anbar əməliyyatlarını avtomatlaşdırır.",
    pawnTitle: "Lombard İdarəetmə Sistemi",
    pawnDesc: "Girov aktivlərini, müştəri fayllarını və maliyyə müqavilələrini izləyir. Gündəlik pərakəndə əməliyyatları sürətləndirir və inventar qeydlərini sadələşdirir.",
    gymTitle: "İdman Zalları və Komplekslərin İdarə Edilməsi",
    gymDesc: "Klub üzvlüklərini, giriş icazələrini, aktiv abunəlikləri və aydın maliyyə hesabatlılığını sadələşdirən veb-əsaslı proqram təminatı.",
    ...
    p1Desc: "Biz qarışıq, həddindən artıq dizayn edilmiş sistemlər qurmuruq. Proqram təminatımız intuitiv tərtibata, oxunaqlı şriftlərə və aydın funksional görünüşlərə yönəlir ki, komandanız uzun təlimlər olmadan dərhal işə başlaya bilsin.",
